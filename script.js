...
welcomeMsg = document.createTextNode("Welcome to Gardenia. To get started, we need some information from you to determine how best to create your personalized gardening calendar."); // Text Node for the current date/time.
